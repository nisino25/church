...
export default{
  data(){
    ...
    return{
      ...
      content1: `歴史の中  dddに、ほとんど影が薄くなっているように思います。
...
<hr>
1. 1988年生～1960年没。
2. 賀川の救済活動は、宗教、医療、保育等、広範囲にわたるセツルメント事業として展開され、江東消費組合や中ノ郷質
庫信用組合を設立した。
3. 持続可能な開発に関する世界首脳会議(World Summit on Sustainable Development) 平成14年8～9月にヨハネスブルクで
開催された。日本からは小泉総理（当時）ほかが参加。

4. NHKで2000年3月から2005年12月まで放映された番組。ナレーターは田口トモロヲ。「料理人たち、炎の東京オリンピ
ック」は、2002年8月27日の回で放送。
5. 2002年8月に多摩川に現れたアザラシ。
6.「予科練」と称され、終戦まであった飛行兵教育を中心とした霞ヶ浦海軍航空隊。軍歌「若鷲の歌」では、「七つボタ
ンは櫻に碇（いかり）」と歌われる一節がある。特攻兵の多くも、ここから巣立っていった。
7 同志社大学の校舎の一つ。
`
,
